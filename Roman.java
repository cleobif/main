public class Roman {
    public static String[] Roman = new String[]{"0", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI",
    ...
    public static String convertToRoman(int a) {
        if (a < 0) throw new IllegalArgumentException("<0");
        return Roman[a];
    }

    public static int applyOperation(char operation, int num1, int num2) {
        switch (operation) {
            case '+':
                return num1 + num2;
            case '-':
